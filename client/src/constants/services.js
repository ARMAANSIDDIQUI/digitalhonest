...
export const services = [
  {
    ...
    shortDesc: 'Strategic and results-driven management services tailored for brands that demand visibility.',
    detailedDescription: 'We understand the pivotal role social media plays in shaping a brand’s identity and fostering meaningful connections. Our team delivers strategic, results-driven management that aligns perfectly with your business objectives, ensuring professional community engagement and content consistency.',
    roi: '+75% Follower Growth',
    features: ['Custom Social Media Strategy', 'Content Creation & Curation', 'Proactive Community Management', 'Regular Analytics & Performance Reports'],
    methodology: [
  ...
  },
  {
    ...
    shortDesc: 'Visually stunning and functionally robust digital homes that exceed expectations.',
    detailedDescription: 'We specialize in creating a seamless and engaging online experience for your audience. Our websites are not just pages; they are robust digital assets designed to convert. From responsive design to SEO readiness, we provide a complete technological backbone for your brand.',
    roi: 'SEO Ready Architecture',
    features: ['Dynamic & Customizable Design', 'SSL, Hosting & Domain Support', 'Social Media & WhatsApp Integration', 'Inquiry Forms & Responsive Layouts'],
    methodology: [
