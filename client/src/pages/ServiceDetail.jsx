  ...
  return (
    ...
    >
      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden bg-surface">
        ...
        <div className="section-padding pt-20 lg:pt-28 relative z-10 w-full grid grid-cols-12 gap-8 items-end pb-32">
          <motion.div variants={itemVariants} className="col-span-12 lg:col-span-10">
            ...
            <h1 className="font-display font-extrabold tracking-tighter leading-none mb-12">
              <span 
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-start">
              ...
              <div className="flex flex-col md:flex-row items-start md:items-center gap-12">
                <Link to="/contact" className="bg-[#ff851b] text-white px-12 py-6 font-display font-bold text-lg rounded-full hover:scale-105 transition-transform shadow-[0_20px_40px_-15px_rgba(255,133,27,0.3)]">
                  Launch Campaign
                </Link>
                <div className="flex flex-col border-l-4 border-[#ff851b] pl-6">
        ...
        <div className="section-padding !max-w-screen-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16 lg:gap-24">
            {service.methodology.map((item, idx) => (
              ...
              >
                <div className="w-16 h-1 bg-[#ff851b]"></div>
                <span className="font-display font-black text-7xl text-[#ff851b]/70 select-none">{item.id}</span>
            ...
            {[1, 2, 3, 1, 2, 3].map((item, idx) => (
              <div key={idx} className="flex-none w-[85vw] md:w-[600px] group">
                ...
                <div className="flex flex-col space-y-4">
                  <span className="text-[#ff851b] text-[10px] font-black uppercase tracking-[0.2em]">{service.tag}</span>
      ...
      <section className="bg-white py-32 relative overflow-hidden">
        <div className="section-padding !max-w-screen-2xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
          <motion.div variants={itemVariants} className="space-y-12 order-2 lg:order-1">
            <span className="text-[#ff851b] text-[10px] font-black uppercase tracking-[0.4em]">Featured Blueprint</span>
            ...
            <div className="grid grid-cols-2 gap-12">
              {service.caseStudy.stats.map((stat, i) => (
                <div key={i} className="space-y-2">
                  <h4 className="text-[#ff851b] font-display font-bold text-5xl tracking-tighter">{stat.value}</h4>
            ...
            <Link to="/portfolio" className="flex items-center space-x-6 group text-[#000613] font-display font-bold text-xl hover:gap-8 transition-all">
              ...
              <FiArrowRight className="text-[#ff851b] group-hover:scale-125 transition-transform" />
            </Link>
          </motion.div>

          <motion.div variants={itemVariants} className="relative group order-1 lg:order-2">
            <div className="absolute -inset-8 bg-[#ff851b]/5 blur-[100px] rounded-full opacity-50 group-hover:opacity-80 transition-opacity duration-1000"></div>
        ...
        <div className="section-padding !max-w-screen-2xl mx-auto">
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                ...
                { label: 'Revenue Managed', val: '₹5Cr+', c: 'text-[#ff851b]' },
                { label: 'Operational Cities', val: '50+', c: 'text-[#ff851b]' },
        ...
        <div className="section-padding !max-w-screen-2xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-32">
          <div className="space-y-12">
            <h2 className="text-6xl lg:text-7xl text-white font-display leading-[1.1]">
              Architect <br/>
              <span className="text-[#ff851b] italic">Your Legacy.</span>
            </h2>
            ...
            <div className="grid gap-8 pt-8">
               <div className="flex items-center gap-6 group">
                  <div className="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center text-[#ff851b] group-hover:bg-[#ff851b] group-hover:text-white transition-all">
                     <FiMapPin />
                  </div>
                  <div>
               ...
               <div className="flex items-center gap-6 group text-white decoration-brand-secondary">
                  ...
                  <a href="tel:+917310688048" className="hover:text-[#ff851b] transition-colors">
          ...
          <div className="glass-card !bg-white !p-12 !rounded-[3rem] shadow-2xl relative">
             <div className="absolute -top-12 -right-12 w-32 h-32 bg-[#ff851b]/10 rounded-full blur-[60px]"></div>
             <form className="space-y-8">
                <div className="space-y-2">
                   ...
                   <input 
                     ...
                     className="w-full bg-transparent border-b-2 border-gray-100 py-4 focus:border-[#ff851b] outline-none transition-all text-xl font-display"
                   />
                </div>
                <div className="space-y-2">
                   <label className="text-[10px] font-black uppercase tracking-widest text-brand-text-muted">Primary Channel</label>
                   <select className="w-full bg-transparent border-b-2 border-gray-100 py-4 focus:border-[#ff851b] outline-none transition-all text-xl font-display appearance-none">
                      <option>{service.title}</option>
                      <option>Omnichannel Hybrid</option>
                      <option>360 Strategy Audit</option>
                   </select>
                </div>
                <button className="w-full bg-[#001f3f] text-white py-6 rounded-2xl font-display font-bold text-xl hover:bg-[#ff851b] transition-all flex items-center justify-center gap-4 group">
