...
const Services = () => {
  ...
  return (
    <div className="pt-16 pb-24 bg-brand-bg">
      <Helmet>
      ...
      <div className="mt-32 px-4 sm:px-8">
        <div className="max-w-7xl mx-auto bg-white rounded-[4rem] shadow-premium overflow-hidden">
          <div className="py-20 px-10 md:px-20 lg:px-24">
              ...
              <div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-brand-text-muted uppercase font-bold tracking-widest"></p>
                  </div>
                </div>
              </div>
